...
public class ExcelExporter extends Object {
    ...
    public void obtainFileName() {
        ...
        if(chooser == null) {
            ...
            chooser.setSelectedFile( new File("fuzzresults.csv") );
	...
	class ProgressDialog extends JDialog {
        ...
        StringBuffer data;
        JTable srcTable;        
        InteractiveTableModel srcModel;
        File targetFile;
        ...
        public ProgressDialog(JTable src, File target) {
            ...
            srcTable = src;
            srcModel = (InteractiveTableModel)src.getModel();
            targetFile = target;
        ...
        public void appendData() {
            ...
            for(int j = 0; j < srcModel.getColumnCount(); j++) {
                ...
                if(rowPoint == -1) {
                	...
                	String text;
                    try{
                    	text = (String)srcModel.getValueAt(rowPoint,col);
                    } catch (ClassCastException e){
                    	Integer textInt = (Integer)srcModel.getValueAt(rowPoint, col);
